...
#SBATCH --output=/scratch/cz3056/CNN_train/Arthur_model/gz21_stencil_size/gz21/slurm/echo/r4train_%A_%a.out
#SBATCH --error=/scratch/cz3056/CNN_train/Arthur_model/gz21_stencil_size/gz21/slurm/echo/r4train_%A_%a.err
#SBATCH --nodes=1
