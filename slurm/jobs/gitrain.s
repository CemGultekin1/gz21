...
#SBATCH --output=/scratch/cz3056/CNN_train/Arthur_model/gz21/slurm/echo/gitrain_%A_%a.out
#SBATCH --error=/scratch/cz3056/CNN_train/Arthur_model/gz21/slurm/echo/gitrain_%A_%a.err
#SBATCH --nodes=1
