...
#SBATCH --output=/scratch/cg3306/climate/subgrid/gz21/slurm/echo/data_test_%A_%a.out
#SBATCH --error=/scratch/cg3306/climate/subgrid/gz21/slurm/echo/data_test_%A_%a.err
#SBATCH --nodes=1
