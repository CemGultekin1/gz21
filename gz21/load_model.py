...
def load_paper_net(device: str = 'gpu'):
    ...
    net = model_cls(2, 4)
    print('After net')
    root = "/scratch/cg3306/climate/temp/gz21_new/gz21/temp/tmp_kx8e0s6/models"
    if device == 'cpu':
        transformation = torch.load(f"{root}/final_transformation.pth")
